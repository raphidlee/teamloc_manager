...
class _MainMapState extends State<MainMap> {
  ...
  Map<Player, List<Location>> members = {};
  @override
  void initState() {
    super.initState();
  ...
  void _drawInitialLines({lastCount = 55}) {
    setState(() {
      polylines = members.entries.map((entry) {
      ...
      Visibility(
          ...
          child: Expanded(
            ...
            child: Container(
              ...
              child:
                  Expanded(child: MemberGrid(players: members.keys.toList())),
            ),
          )),
    ]));
  }
